...
UBUNTU_TRANSLATION_DOMAIN="todoorg.michael"
...
aptest.commands = bash $$PWD/TodoOrg/tests/autopilot/run
aptest.depends  = sub-TodoOrg

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/TodoOrg/tests/unit 
unittest.depends  = sub-TodoOrg
